...
import netvision.izvestaji.PregledIzvestajaFrame;
...
public class PregledRucniRadFrame extends javax.swing.JFrame {
    ...
    private void jButtonFilterIzlistajRadneNalogeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonFilterIzlistajRadneNalogeActionPerformed
        ...
        List<dbOld.Rucnirad> result = rucniRadDb.getRucniRadWhere(filterDatumOd.getText(), filterDatumDo.getText());
        fillTableRN(result);
    ...
    public void getAll(){
        List<dbOld.Rucnirad> result = rucniRadDb.getRucniRad();
        fillTableRN(result);
    }
    
    
    private void fillTableRN(List<dbOld.Rucnirad> result) {
        int i = 0;
        Object[][] obj = new Object[result.size()][10];
        for (dbOld.Rucnirad auto : result) {
            obj[i][0] = i + 1;
