...
@NamedQueries({
    ...
    , @NamedQuery(name = "Gradiliste.findByKupacid", query = "SELECT g FROM Gradiliste g WHERE g.kupacid = :kupacid")})
public class Gradiliste implements Serializable {
    ...
    public Gradiliste(Long id, String gradiliste, boolean aktivno, long kupacid) {
        this.id = id;
